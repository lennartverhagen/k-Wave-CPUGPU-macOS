...
class ComplexMatrix : public BaseFloatMatrix
{
  public:
    ...
    /**
     * @brief  Get raw device complex data out of the class (for direct kernel access) .
     * @return Mutable matrix data.
     */
    ...
    /**
     * @brief  Get raw device raw complex data out of the class (for direct kernel access).
     * @return Immutable matrix data.
     */
