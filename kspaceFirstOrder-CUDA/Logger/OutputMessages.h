...
OutputMessage kOutFmtHostMemoryUsage
  = kOutFmtVerticalLine + " Peak host memory in use:                           %8luMB " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtDeviceMemoryUsage
  = kOutFmtVerticalLine + " Peak device memory in use:                         %8luMB " + kOutFmtEol;;
/// Output message
...
OutputMessage kOutFmtSelectedDevice
  = kOutFmtVerticalLine + " Selected GPU device id:                                ";
/// Output message.
...
OutputMessage kOutFmtDeviceName
  = kOutFmtVerticalLine + " GPU device name: %44s "  + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtDeviceNameUnknown
  = "N/A";
/// Output message.
...
OutputMessage kOutFmtCurrentDeviceMemory
  = kOutFmtVerticalLine + " Current device memory in use:                      %8luMB " + kOutFmtEol;
/// Output message.
