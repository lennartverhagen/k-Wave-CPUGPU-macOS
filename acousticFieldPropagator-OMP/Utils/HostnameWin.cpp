/**
 * @file Utils/HostnameWin.cpp
 *
 * @brief Windows-specific implementation of obtaining hostname and FQDN
 *
...
/// Class ensuring cleanup of Windows Socket API
class WSACleaner
{
  public:
    /// Destructor calling cleanup function when an object of this class falls out of scope
    ~WSACleaner() { WSACleanup(); }
};// end of WSACleaner
//----------------------------------------------------------------------------------------------------------------------
...
/**
 * @brief Get host name, Windows version
 */
std::string getHostname()
{
  ...
  WSACleaner wsScopedObject;

  // check the returned Windows Sockets version
